...
import firstImage from './__fixtures__/beyond-earth.jpg'
import secondImage from './__fixtures__/bottom-gear.jpg'
import thirdImage from './__fixtures__/undiscovered-cities.jpg'
